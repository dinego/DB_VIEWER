...
const server = "https://salarymark-api.carreira.com.br/api/";
const serverCS = "https://csnew-api.carreira.com.br/api/";
const account = "https://autenticador-api.carreira.com.br/api/";

export const environment = {
  fakeToken: "",
  production: true,
  version: env.npm_package_version,
  autenticatorUrl: "https://autenticador.carreira.com.br/login/logout",
  baseUrl: "https://salarymark.carreira.com.br/",
  siteCsUrl: "https://consultasalarial.carreira.com.br",
  ...
  api: {
    ...
    salaryTable: {
      ...
      updateSalarialTable: `${server}TableSalary/UpdateSalaryTable`,
