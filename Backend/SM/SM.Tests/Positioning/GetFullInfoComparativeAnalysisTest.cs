...
{
    [TestClass]
    public class GetFullInfoComparativeAnalysisTest
    {
        ...
        public GetFullInfoComparativeAnalysisTest()
        {
        ...
        public async Task IsOK()
        {
            ...
            var getFullInfoComparativeAnalysisHandler =
                        new GetFullInfoComparativeAnalysisHandler(unitOfWork,
                        permissionUserInteractor,
                        getLabelDisplayByInteractor,
                        getGlobalLabelsInteractor);

            var request = new GetFullInfoComparativeAnalysisRequest
            {
            ...
            var result = await getFullInfoComparativeAnalysisHandler.Handle(request, CancellationToken.None);

            Assert.AreNotSame(new GetFullInfoComparativeAnalysisRequest(), result);
