...
{
    public class GetComparativeAnalysisTableExcelValidators
        : AbstractValidator<GetComparativeAnalysisTableExcelRequest>
    {
        public GetComparativeAnalysisTableExcelValidators(IPermissionUserInteractor permissionUserInteractor)
        {
            RuleFor(x => x)
