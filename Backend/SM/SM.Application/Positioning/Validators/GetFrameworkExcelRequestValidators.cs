...
{
    public class GetFrameworkExcelRequestValidators
         : AbstractValidator<GetFrameworkExcelRequest>
    {
        public GetFrameworkExcelRequestValidators(IPermissionUserInteractor permissionUserInteractor)
        {
            RuleFor(x => x)
