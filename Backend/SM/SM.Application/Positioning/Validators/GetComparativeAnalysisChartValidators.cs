...
{
    public class GetComparativeAnalysisChartValidators
        : AbstractValidator<GetComparativeAnalysisChartRequest>
    {
        public GetComparativeAnalysisChartValidators(IPermissionUserInteractor permissionUserInteractor)
        {
            RuleFor(x => x)
