...
{
    public class GetProposedMovementsChartValidators
        : AbstractValidator<GetProposedMovementsChartRequest>
    {
        public GetProposedMovementsChartValidators(IPermissionUserInteractor permissionUserInteractor)
        {
            RuleFor(x => x)
