...
{
    public class GetDistributionAnalysisChartValidators
        : AbstractValidator<GetDistributionAnalysisChartRequest>
    {
        public GetDistributionAnalysisChartValidators(IPermissionUserInteractor permissionUserInteractor)
        {
            RuleFor(x => x)
