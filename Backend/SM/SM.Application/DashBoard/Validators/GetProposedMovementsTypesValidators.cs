...
{
    public class GetProposedMovementsTypesValidators
        : AbstractValidator<GetProposedMovementsTypesRequest>
    {
        public GetProposedMovementsTypesValidators(IPermissionUserInteractor permissionUserInteractor)
        {
            RuleFor(x => x)
