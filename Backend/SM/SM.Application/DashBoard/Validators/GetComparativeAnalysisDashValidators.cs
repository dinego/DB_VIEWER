...
{
    public class GetComparativeAnalysisDashValidators
        : AbstractValidator<GetComparativeAnalysisDashRequest>
    {
        public GetComparativeAnalysisDashValidators(IPermissionUserInteractor permissionUserInteractor)
        {
            RuleFor(x => x)
