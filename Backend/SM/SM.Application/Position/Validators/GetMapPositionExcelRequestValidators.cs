...
{
    public class GetMapPositionExcelRequestValidators
        : AbstractValidator<GetMapPositionExcelRequest>
    {
        public GetMapPositionExcelRequestValidators(IPermissionUserInteractor permissionUserInteractor)
        {
